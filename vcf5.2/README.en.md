...
## System Topology — VCF 5.2 Nested Lab
...
| Script | Purpose |
|--------|---------|
| [`vcf-automated-lab-deployment.ps1`](vcf-automated-lab-deployment.ps1) | Deploys Nested ESXi & Cloud Builder VMs, then deploys VCF Management Domain (bringup) |
| [`vcf-automated-workload-domain-deployment.ps1`](vcf-automated-workload-domain-deployment.ps1) | Commissions hosts & deploys VCF Workload Domain via SDDC Manager API |
| [`sample-vcf-mgmt-variables.ps1`](sample-vcf-mgmt-variables.ps1) | Configuration template for Management Domain deployment |
| [`sample-vcf-wld-variables.ps1`](sample-vcf-wld-variables.ps1) | Configuration template for Workload Domain deployment |

### Screenshots

| Screenshot | Description |
|------------|-------------|
| [`screenshot-0.png`](screenshots/screenshot-0.png) | Logical topology diagram of the full VCF nested lab |
| [`screenshot-1.png`](screenshots/screenshot-1.png) | Script execution — pre-flight checks & confirmation |
| [`screenshot-2.png`](screenshots/screenshot-2.png) | Successful Nested ESXi + Cloud Builder VM deployment |
| [`screenshot-3.png`](screenshots/screenshot-3.png) | vApp containing all 9 VMs (8 ESXi + 1 Cloud Builder) |
| [`screenshot-4.png`](screenshots/screenshot-4.png) | VCF Management Domain bringup progress in SDDC Manager |
| [`screenshot-6.png`](screenshots/screenshot-6.png) | Management Domain deployment success |
| [`screenshot-7.png`](screenshots/screenshot-7.png) | SDDC Manager login after bringup |
| [`screenshot-8.png`](screenshots/screenshot-8.png) | Commission Hosts UI uploading JSON |
| [`screenshot-9.png`](screenshots/screenshot-9.png) | Workload Domain deployment in SDDC Manager |
| [`screenshot-10.png`](screenshots/screenshot-10.png) | Workload Domain script — pre-flight checks |
| [`screenshot-11.png`](screenshots/screenshot-11.png) | Workload Domain script — completed |
| [`screenshot-12.png`](screenshots/screenshot-12.png) | Workload Domain deployment progress |
| [`screenshot-13.png`](screenshots/screenshot-13.png) | Workload Domain deployment success |
| [`screenshot-14.png`](screenshots/screenshot-14.png) | Full inventory after both domains deployed |
